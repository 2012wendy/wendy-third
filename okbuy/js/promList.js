...
Banner.prototype.moveBoder = function(){
	let lis = this.boxDom.children;	
	for(var i= 0;i<lis.length;i++){
		let index = i;//这里的index每次都会被重新定义并且赋值
		lis[i].onmouseover = function(){//方括号里写index效果一样lis[index]
			lis[index].firstElementChild.style.border = "1px solid #d70057";
		}
		lis[i].onmouseout = function(){
			lis[index].firstElementChild.style.border = "1px solid #e9e7ea";
		}
	}
